...
#define SRF04_PARAM_TRIGGER     GPIO_PIN(PORT_F, 13)
#endif
#ifndef SRF04_PARAM_ECHO
#define SRF04_PARAM_ECHO        GPIO_PIN(PORT_E, 9)
#endif
#ifndef SRF04_PARAM_POWER
#define SRF04_PARAM_POWER        GPIO_PIN(PORT_E, 11)
#endif
