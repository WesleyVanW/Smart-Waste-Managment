 ...
 *
 * @file
 * @brief       Test application for the LSM303AGR accelerometer/magnetometer
 *
...
int main(void)
{
    ...
    puts("LSM303AGR temperature test application\n");
    puts("Initializing LSM303AGR sensor");
    ...
    while (1) {
        ...
        /*
        if (lsm303agr_read_temp(&dev, &temp_value) == 0) {
